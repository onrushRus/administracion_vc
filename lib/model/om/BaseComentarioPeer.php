...
abstract class BaseComentarioPeer {
	...
	const SOCIO_ID = 'comentario.SOCIO_ID';

	/** the column name for the PELICULA_ID field */
	const PELICULA_ID = 'comentario.PELICULA_ID';

	/** the column name for the DETALLE field */
	const DETALLE = 'comentario.DETALLE';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'SocioId', 'PeliculaId', 'Detalle', 'Fecha', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'socioId', 'peliculaId', 'detalle', 'fecha', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SOCIO_ID, self::PELICULA_ID, self::DETALLE, self::FECHA, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SOCIO_ID', 'PELICULA_ID', 'DETALLE', 'FECHA', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'socio_id', 'pelicula_id', 'detalle', 'fecha', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'SocioId' => 1, 'PeliculaId' => 2, 'Detalle' => 3, 'Fecha' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'socioId' => 1, 'peliculaId' => 2, 'detalle' => 3, 'fecha' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SOCIO_ID => 1, self::PELICULA_ID => 2, self::DETALLE => 3, self::FECHA => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SOCIO_ID' => 1, 'PELICULA_ID' => 2, 'DETALLE' => 3, 'FECHA' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'socio_id' => 1, 'pelicula_id' => 2, 'detalle' => 3, 'fecha' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ComentarioPeer::SOCIO_ID);
			$criteria->addSelectColumn(ComentarioPeer::PELICULA_ID);
			$criteria->addSelectColumn(ComentarioPeer::DETALLE);
			$criteria->addSelectColumn(ComentarioPeer::FECHA);
		} else {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseComentarioPeer', $criteria, $con);
		}
	...
	public static function doCountJoinSocio(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ComentarioPeer::SOCIO_ID, SocioPeer::ID, $join_behavior);
	...
	public static function doCountJoinPelicula(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ComentarioPeer::PELICULA_ID, PeliculaPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with their Socio objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinSocio(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to $obj2 (Socio)
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with their Pelicula objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Comentario objects.
	...
	public static function doSelectJoinPelicula(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to $obj2 (Pelicula)
				$obj2->addComentario($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj2 (Socio)
				$obj2->addComentario($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj3 (Pelicula)
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with all related objects except Socio.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptSocio(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ComentarioPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Comentario) to the collection in $obj2 (Pelicula)
				$obj2->addComentario($obj1);
	...
	/**
	 * Selects a collection of Comentario objects pre-filled with all related objects except Pelicula.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseComentarioPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
