...
abstract class BaseCategoria extends BaseObject  implements Persistent
{
	...
	public function setTipo($v)
	{
		...
		if ($this->tipo !== $v) {
			$this->tipo = $v;
			$this->modifiedColumns[] = CategoriaPeer::TIPO;
		}
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(CategoriaPeer::TIPO)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CategoriaPeer::TIPO)) $criteria->add(CategoriaPeer::TIPO, $this->tipo);
	 ...
	 * @return     PropelCollection|array Pelicula[] List of Pelicula objects
	 */
	public function getPeliculasJoinEstadoPelicula($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = PeliculaQuery::create(null, $criteria);
		$query->joinWith('EstadoPelicula', $join_behavior);
